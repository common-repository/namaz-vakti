...
Class Namaz {
   ...
   // kullanıcının zaman bölgesini almaca. error verirse türkiye saatini kullansın.
   public function deviceTime($dateFormatString)
   { 
      $responseTime = 21;
      ...
      if(!array_key_exists("error", $ipParts)) {
