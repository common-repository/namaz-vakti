...
Plugin URI: http://www.eralabs.net/
...
$nv = new Namaz( NV_PLUGIN_DIR . 'cache' . DIRECTORY_SEPARATOR);
...
Class WP_Namazvakti
{
	...
	*/
	public function __namazvakti_init()
	{
		...
		wp_enqueue_script( 'jquery'); // jquery javascript kütüphanesi - sistem tarafından eklenmemişse eklensin...
